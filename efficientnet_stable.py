...
with tf.device(device):
    ...
    iou_aware_model.fit(train_X, train_y, batch_size=12, epochs=100,
    ...
    iou_aware_model.fit(train_X, train_y, batch_size=6, epochs=100,
    ...
    iou_aware_model.fit(train_X, train_y, batch_size=4, epochs=100,
